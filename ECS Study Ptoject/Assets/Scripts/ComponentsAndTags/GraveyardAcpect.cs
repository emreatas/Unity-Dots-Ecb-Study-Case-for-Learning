...
public readonly partial struct GraveyardAcpect : IAspect
{
    ...
    private readonly RefRW<ZombieSpawnerTime> _zombieSpawnTimer;
    ...
    public int ZombieSpawnPointCount => _zombieSpawnPoints.ValueRO.Value.Value.Value.Length;
